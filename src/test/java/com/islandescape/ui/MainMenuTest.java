...
public class MainMenuTest {
    ...
    public void moveDownAdvancesThroughOptions() {
        ...
        menu.moveDown();
        assertEquals(MenuOption.MANUAL, menu.getSelected());
        menu.moveDown();
    ...
    @Test
    public void manualIsSelectableBetweenLoadGameAndQuit() {
        menu.moveDown();
        menu.moveDown();
        assertEquals(MenuOption.MANUAL, menu.getSelected());
    }
    ...
    @Test
    public void confirmInvokesManualHook() {
        AtomicBoolean fired = new AtomicBoolean(false);
        menu.setOnManual(() -> fired.set(true));
        menu.moveDown();
        menu.moveDown();
        menu.confirm();
        assertTrue(fired.get());
